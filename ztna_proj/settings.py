"""
Django settings for ztna_proj project.
...
SECRET_KEY = 'django-insecure-!7k8k&ab2#k7rkqg*yiep__a8yhhdmwey!#h+dx$*#2eq+gt-y'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'ztna' / 'templates',
            BASE_DIR / 'idp' / 'templates',
            BASE_DIR / 'policy' / 'templates',
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ztna_proj.wsgi.application'
